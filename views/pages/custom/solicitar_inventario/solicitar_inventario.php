            ...
            <div class="card rounded border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="requestProductId" required>
                            <option value="">-- Seleccionar producto --</option>
                            <?php foreach($products as $prod): ?>
                                <?php if((int)$prod->stock_product > 0): ?>
                                <option value="<?php echo $prod->id_product ?>" data-stock="<?php echo $prod->stock_product ?>">
                                    <?php echo urldecode($prod->title_product) ?> (Stock: <?php echo $prod->stock_product ?>)
                                </option>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </select>
...
function loadMyRequests(){
    $.ajax({
        ...
        success: function(data){
            ...
            var html = '<div class="table-responsive"><table class="table table-bordered table-striped" id="myRequestsTable"><thead><tr><th>Fecha</th><th>Producto</th><th>Solicitado</th><th>Despachado</th><th>Estado</th><th>Notas</th></tr></thead><tbody>';
