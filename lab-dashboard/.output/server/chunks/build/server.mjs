...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    async function fetchNotifications() {
      ...
      const calls = [
        { key: "getLabEntries", target: pendingEntries, filter: (e) => e.status_entry === "pendiente" },
        { key: "getLabProductions", target: activeProductions, filter: (p) => p.status_production === "en_proceso" || p.status_production === "pendiente" },
        { key: "getLabQCTests", target: pendingQCTests, filter: (q) => q.status_qc === "pendiente" },
        { key: "getLabMaterials", target: lowStockMaterials, filter: (m) => (parseFloat(m.stock_raw_material) || 0) <= 0 }
      ];
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(route).path === "/login") {
              ...
              _push2(`<div class="flex h-dvh bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 font-sans overflow-hidden"${_scopeId}>`);
              if (sidebarOpen.value) {
                _push2(`<div class="fixed inset-0 z-30 bg-black/50 lg:hidden"${_scopeId}></div>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              ])}"${_scopeId}><div class="h-16 px-4 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between shrink-0"${_scopeId}><div class="flex items-center gap-2.5 min-w-0"${_scopeId}><div class="${ssrRenderClass(["w-8 h-8 rounded-lg flex items-center justify-center shrink-0", unref(auth).mode === "pos" ? "bg-blue-600" : "bg-green-600"])}"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: unref(auth).mode === "pos" ? "i-lucide-monitor-smartphone" : "i-lucide-flask-conical",
                class: "w-4 h-4 text-white"
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="min-w-0"${_scopeId}><span class="font-bold text-sm text-slate-800 dark:text-white block leading-tight"${_scopeId}>UniTech ERP</span><span class="${ssrRenderClass(["text-[10px] font-semibold", unref(auth).mode === "pos" ? "text-blue-500" : "text-green-500"])}"${_scopeId}>${ssrInterpolate(unref(auth).mode === "pos" ? "Sistema POS" : "Laboratorio")}</span></div></div><div class="flex items-center gap-1"${_scopeId}>`);
              ...
              _push2(`</div></div><nav class="flex-1 overflow-y-auto py-2 px-2 space-y-3"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<span${_scopeId2}>Dashboard</span>`);
                  } else {
                    return [
              ...
              _push2(`<!--[-->`);
              ssrRenderList(sidebarSections.value, (section) => {
                _push2(`<div${_scopeId}><p class="px-3 mb-1 text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-600"${_scopeId}>${ssrInterpolate(section.title)}</p><div class="space-y-0.5"${_scopeId}><!--[-->`);
                  ...
                  _push2(ssrRenderComponent(_component_NuxtLink, {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        ...
                        _push3(`<span class="truncate"${_scopeId2}>${ssrInterpolate(item.label)}</span>`);
                      } else {
                        return [
                          createVNode(_component_UIcon, {
                            name: item.icon,
              ...
              _push2(`<!--]--></nav><div class="px-3 pb-2 shrink-0"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UButton, {
                block: "",
                variant: "soft",
                size: "xs",
                color: unref(auth).mode === "pos" ? "success" : "primary",
                icon: unref(auth).mode === "pos" ? "i-lucide-flask-conical" : "i-lucide-monitor-smartphone",
                onClick: () => {
                  unref(auth).setMode(unref(auth).mode === "pos" ? "lab" : "pos");
                  ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))(unref(auth).mode === "pos" ? "/pos" : "/");
                }
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(` Ir a ${ssrInterpolate(unref(auth).mode === "pos" ? "Laboratorio" : "Sistema POS")}`);
                  } else {
                    return [
                      createTextVNode(" Ir a " + toDisplayString(unref(auth).mode === "pos" ? "Laboratorio" : "Sistema POS"), 1)
                    ];
                  }
                }),
                _: 1
              }, _parent2, _scopeId));
              _push2(`</div><div class="p-3 border-t border-slate-200 dark:border-slate-800 flex items-center gap-3 shrink-0"${_scopeId}><div class="${ssrRenderClass(["w-9 h-9 rounded-full flex items-center justify-center shrink-0", unref(auth).mode === "pos" ? "bg-blue-100 dark:bg-blue-900/40" : "bg-green-100 dark:bg-green-900/40"])}"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                name: "i-lucide-user",
                class: ["w-5 h-5", unref(auth).mode === "pos" ? "text-blue-600" : "text-green-600"]
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="truncate flex-1 min-w-0"${_scopeId}><p class="text-sm font-semibold text-slate-800 dark:text-white truncate"${_scopeId}>${ssrInterpolate(unref(auth).user?.name_admin || "Usuario")}</p><span class="text-xs text-slate-500 dark:text-slate-400 block truncate"${_scopeId}>${ssrInterpolate(roleLabel.value)}</span></div>`);
              _push2(ssrRenderComponent(_component_UButton, {
              ...
              _push2(`</div></aside><main class="flex-1 flex flex-col min-w-0 overflow-hidden"${_scopeId}><header class="h-14 lg:h-16 border-b border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-950/60 backdrop-blur-sm px-4 lg:px-6 flex items-center justify-between shrink-0 gap-3"${_scopeId}><div class="flex items-center gap-3 min-w-0"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UButton, {
                icon: "i-lucide-menu",
                variant: "ghost",
                color: "neutral",
              ...
              _push2(`<div class="min-w-0"${_scopeId}><h1 class="text-sm lg:text-base font-bold text-slate-800 dark:text-white truncate"${_scopeId}>${ssrInterpolate(pageTitle.value)}</h1><p class="text-xs text-slate-500 dark:text-slate-400 hidden sm:block truncate"${_scopeId}> Sucursal: <span class="text-green-600 font-medium"${_scopeId}>${ssrInterpolate(unref(auth).office?.title_office ? decodeURIComponent(unref(auth).office.title_office).replace(/\+/g, " ") : "Principal")}</span></p></div></div><div class="flex items-center gap-2 shrink-0"${_scopeId}>`);
              if (["lab_admin", "lab_worker", "lab_calidad", "superadmin", "admin"].includes(unref(auth).role)) {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            if (totalNotificationsCount.value > 0) {
                              _push4(`<span class="absolute -top-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-rose-500 text-[9px] font-bold text-white animate-pulse"${_scopeId3}>${ssrInterpolate(totalNotificationsCount.value)}</span>`);
                            } else {
                              _push4(`<!---->`);
                            }
                          } else {
                            return [
                              totalNotificationsCount.value > 0 ? (openBlock(), createBlock("span", {
                                key: 0,
                                class: "absolute -top-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-rose-500 text-[9px] font-bold text-white animate-pulse"
              ...
              _push2(`<div class="text-right hidden md:block"${_scopeId}><p class="text-xs text-slate-500 dark:text-slate-400 leading-none"${_scopeId}>Hoy</p><p class="text-xs font-semibold text-slate-700 dark:text-slate-200 mt-0.5"${_scopeId}>${ssrInterpolate(todayLabel.value)}</p></div></div></header><section class="erp-content flex-1 overflow-y-auto p-3 sm:p-4 lg:p-5 bg-slate-50 dark:bg-slate-900"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_NuxtPage, null, null, _parent2, _scopeId));
            ...
            return [
              unref(route).path === "/login" ? (openBlock(), createBlock(_component_NuxtPage, { key: 0 })) : (openBlock(), createBlock("div", {
                key: 1,
                class: "flex h-dvh bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 font-sans overflow-hidden"
              }, [
                ...
                createVNode("aside", {
                  ...
                  createVNode("div", { class: "h-16 px-4 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between shrink-0" }, [
                    createVNode("div", { class: "flex items-center gap-2.5 min-w-0" }, [
                      createVNode("div", {
                        class: ["w-8 h-8 rounded-lg flex items-center justify-center shrink-0", unref(auth).mode === "pos" ? "bg-blue-600" : "bg-green-600"]
                      }, [
                        createVNode(_component_UIcon, {
                          name: unref(auth).mode === "pos" ? "i-lucide-monitor-smartphone" : "i-lucide-flask-conical",
                          class: "w-4 h-4 text-white"
                      ...
                      createVNode("div", { class: "min-w-0" }, [
                        createVNode("span", { class: "font-bold text-sm text-slate-800 dark:text-white block leading-tight" }, "UniTech ERP"),
                        createVNode("span", {
                          class: ["text-[10px] font-semibold", unref(auth).mode === "pos" ? "text-blue-500" : "text-green-500"]
                        }, toDisplayString(unref(auth).mode === "pos" ? "Sistema POS" : "Laboratorio"), 3)
                      ])
                    ]),
                  ...
                  createVNode("nav", { class: "flex-1 overflow-y-auto py-2 px-2 space-y-3" }, [
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(sidebarSections.value, (section) => {
                      return openBlock(), createBlock("div", {
                        key: section.title
                      }, [
                        createVNode("p", { class: "px-3 mb-1 text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-600" }, toDisplayString(section.title), 1),
                  ...
                  createVNode("div", { class: "px-3 pb-2 shrink-0" }, [
                    createVNode(_component_UButton, {
                      block: "",
                      variant: "soft",
                      size: "xs",
                      ...
                      _: 1
                    }, 8, ["color", "icon", "onClick"])
                  ]),
                  createVNode("div", { class: "p-3 border-t border-slate-200 dark:border-slate-800 flex items-center gap-3 shrink-0" }, [
                    createVNode("div", {
                      class: ["w-9 h-9 rounded-full flex items-center justify-center shrink-0", unref(auth).mode === "pos" ? "bg-blue-100 dark:bg-blue-900/40" : "bg-green-100 dark:bg-green-900/40"]
                    }, [
                      createVNode(_component_UIcon, {
                        name: "i-lucide-user",
                        class: ["w-5 h-5", unref(auth).mode === "pos" ? "text-blue-600" : "text-green-600"]
                    ...
                    createVNode("div", { class: "truncate flex-1 min-w-0" }, [
                      createVNode("p", { class: "text-sm font-semibold text-slate-800 dark:text-white truncate" }, toDisplayString(unref(auth).user?.name_admin || "Usuario"), 1),
                      createVNode("span", { class: "text-xs text-slate-500 dark:text-slate-400 block truncate" }, toDisplayString(roleLabel.value), 1)
                    ]),
                    createVNode(_component_UButton, {
                      icon: "i-lucide-log-out",
                      variant: "ghost",
                ...
                createVNode("main", { class: "flex-1 flex flex-col min-w-0 overflow-hidden" }, [
                  createVNode("header", { class: "h-14 lg:h-16 border-b border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-950/60 backdrop-blur-sm px-4 lg:px-6 flex items-center justify-between shrink-0 gap-3" }, [
                    createVNode("div", { class: "flex items-center gap-3 min-w-0" }, [
                      ...
                      createVNode("div", { class: "min-w-0" }, [
                        createVNode("h1", { class: "text-sm lg:text-base font-bold text-slate-800 dark:text-white truncate" }, toDisplayString(pageTitle.value), 1),
                        createVNode("p", { class: "text-xs text-slate-500 dark:text-slate-400 hidden sm:block truncate" }, [
                          createTextVNode(" Sucursal: "),
                          createVNode("span", { class: "text-green-600 font-medium" }, toDisplayString(unref(auth).office?.title_office ? decodeURIComponent(unref(auth).office.title_office).replace(/\+/g, " ") : "Principal"), 1)
                        ])
                      ])
                    ]),
                    createVNode("div", { class: "flex items-center gap-2 shrink-0" }, [
                      ["lab_admin", "lab_worker", "lab_calidad", "superadmin", "admin"].includes(unref(auth).role) ? (openBlock(), createBlock(_component_UDropdownMenu, {
                        key: 0,
                        items: notificationItems.value,
                        content: { align: "end" },
                        ui: { content: "w-72 max-h-96 overflow-y-auto z-50" }
                      ...
                      createVNode("div", { class: "text-right hidden md:block" }, [
                        createVNode("p", { class: "text-xs text-slate-500 dark:text-slate-400 leading-none" }, "Hoy"),
                        createVNode("p", { class: "text-xs font-semibold text-slate-700 dark:text-slate-200 mt-0.5" }, toDisplayString(todayLabel.value), 1)
                      ])
                    ])
                  ]),
                  createVNode("section", { class: "erp-content flex-1 overflow-y-auto p-3 sm:p-4 lg:p-5 bg-slate-50 dark:bg-slate-900" }, [
