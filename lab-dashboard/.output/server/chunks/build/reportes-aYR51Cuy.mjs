...
import { _ as _sfc_main$2 } from './Tabs-fNkZ4Vjh.mjs';
import { _ as _sfc_main$3 } from './Table-EJSLuWs0.mjs';
import { _ as _sfc_main$4 } from './Badge-LaytOPGg.mjs';
import { _ as __nuxt_component_7 } from './OrderReceiptModal-BFUV5YHg.mjs';
import { _ as _sfc_main$5 } from './Modal-ulV1aY0B.mjs';
import { _ as _sfc_main$7 } from './FormField-H4QVgNpC.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4"><div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl p-4 text-white shadow-md flex justify-between items-center transition-all hover:scale-[1.02] duration-200"><div><p class="text-emerald-100 text-[10px] font-bold uppercase tracking-wider">Total Facturado</p><h2 class="text-3xl font-black mt-1.5 font-mono">${ssrInterpolate(formatCurrency(totalVentasBs.value))}</h2><span class="text-[9px] bg-white/20 px-2 py-0.5 rounded-full inline-block mt-2 font-medium">✓ Ventas Netas</span></div>`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-banknote",
        class: "w-12 h-12 text-white/30 shrink-0"
      }, null, _parent));
      _push(`</div><div class="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-xl p-4 text-white shadow-md flex justify-between items-center transition-all hover:scale-[1.02] duration-200"><div><p class="text-indigo-100 text-[10px] font-bold uppercase tracking-wider">Órdenes Procesadas</p><h2 class="text-3xl font-black mt-1.5 font-mono">${ssrInterpolate(orders.value.length)}</h2><span class="text-[9px] bg-white/20 px-2 py-0.5 rounded-full inline-block mt-2 font-medium">↑ Transacciones</span></div>`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-shopping-cart",
        class: "w-12 h-12 text-white/30 shrink-0"
      }, null, _parent));
      _push(`</div><div class="bg-gradient-to-br from-amber-500 to-orange-600 rounded-xl p-4 text-white shadow-md flex justify-between items-center transition-all hover:scale-[1.02] duration-200"><div><p class="text-amber-100 text-[10px] font-bold uppercase tracking-wider">Ticket Promedio</p><h2 class="text-3xl font-black mt-1.5 font-mono">${ssrInterpolate(formatCurrency(avgOrder.value))}</h2><span class="text-[9px] bg-white/20 px-2 py-0.5 rounded-full inline-block mt-2 font-medium">⇆ Por Transacción</span></div>`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-trending-up",
        class: "w-12 h-12 text-white/30 shrink-0"
      }, null, _parent));
      _push(`</div><div class="bg-gradient-to-br from-fuchsia-500 to-purple-600 rounded-xl p-4 text-white shadow-md flex justify-between items-center transition-all hover:scale-[1.02] duration-200"><div><p class="text-fuchsia-100 text-[10px] font-bold uppercase tracking-wider">Productos Vendidos</p><h2 class="text-3xl font-black mt-1.5 font-mono">${ssrInterpolate(totalProductsQty.value)} u.</h2><span class="text-[9px] bg-white/20 px-2 py-0.5 rounded-full inline-block mt-2 font-medium">📦 Volumen total</span></div>`);
      _push(ssrRenderComponent(_component_UIcon, {
        name: "i-lucide-package",
        class: "w-12 h-12 text-white/30 shrink-0"
      }, null, _parent));
      _push(`</div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4">`);
      _push(ssrRenderComponent(_component_UCard, { class: "border border-slate-200 dark:border-slate-800 shadow-sm rounded-xl" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h3 class="font-extrabold text-slate-800 dark:text-white"${_scopeId}>Resumen General</h3></div>`);
          } else {
            return [
              createVNode("div", { class: "flex items-center gap-2" }, [
                ...
                createVNode("h3", { class: "font-extrabold text-slate-800 dark:text-white" }, "Resumen General")
              ])
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-4"${_scopeId}><div class="flex justify-between items-center py-1"${_scopeId}><span class="text-slate-500 font-semibold text-xs uppercase"${_scopeId}>Subtotal General:</span><span class="font-bold text-slate-800 dark:text-white font-mono"${_scopeId}>${ssrInterpolate(formatCurrency(sumSubtotal.value))}</span></div><div class="flex justify-between items-center py-1 border-t border-slate-100 dark:border-slate-800"${_scopeId}><span class="text-slate-500 font-semibold text-xs uppercase"${_scopeId}>Descuentos Aplicados (-):</span><span class="font-bold text-rose-500 font-mono"${_scopeId}>${ssrInterpolate(formatCurrency(sumDiscount.value))}</span></div><div class="flex justify-between items-center pt-3 border-t border-slate-200 dark:border-slate-700 text-lg font-black"${_scopeId}><span class="text-slate-800 dark:text-white"${_scopeId}>TOTAL FACTURADO:</span><span class="text-emerald-600 dark:text-emerald-400 font-mono"${_scopeId}>${ssrInterpolate(formatCurrency(totalVentasBs.value))}</span></div></div>`);
          } else {
            return [
              createVNode("div", { class: "space-y-4" }, [
                createVNode("div", { class: "flex justify-between items-center py-1" }, [
                  createVNode("span", { class: "text-slate-500 font-semibold text-xs uppercase" }, "Subtotal General:"),
                  createVNode("span", { class: "font-bold text-slate-800 dark:text-white font-mono" }, toDisplayString(formatCurrency(sumSubtotal.value)), 1)
                ]),
                createVNode("div", { class: "flex justify-between items-center py-1 border-t border-slate-100 dark:border-slate-800" }, [
                  createVNode("span", { class: "text-slate-500 font-semibold text-xs uppercase" }, "Descuentos Aplicados (-):"),
                  createVNode("span", { class: "font-bold text-rose-500 font-mono" }, toDisplayString(formatCurrency(sumDiscount.value)), 1)
                ]),
                createVNode("div", { class: "flex justify-between items-center pt-3 border-t border-slate-200 dark:border-slate-700 text-lg font-black" }, [
                  createVNode("span", { class: "text-slate-800 dark:text-white" }, "TOTAL FACTURADO:"),
                  createVNode("span", { class: "text-emerald-600 dark:text-emerald-400 font-mono" }, toDisplayString(formatCurrency(totalVentasBs.value)), 1)
                ])
              ])
            ];
          }
          ...
          if (_push2) {
            ...
            if (orders.value.length > 0) {
              _push2(ssrRenderComponent(unref(Bar), {
                ...
                items: { responsive: true, maintainAspectRatio: false }
              }, null, _parent2, _scopeId));
            } else {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(unref(Bar), {
                ...
                items: { responsive: true, maintainAspectRatio: false, indexAxis: "x" }
              }, null, _parent2, _scopeId));
              _push2(`</div>`);
            } else {
              return [
...
//# sourceMappingURL=reportes-aYR51Cuy.mjs.map
