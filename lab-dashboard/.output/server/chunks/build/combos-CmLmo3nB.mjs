import { H as useAuthStore, a5 as useToast, g as _sfc_main$c, h as _sfc_main$h, j as _sfc_main$6 } from './server.mjs';
import { _ as _sfc_main$1 } from './Card-DphZz1jr.mjs';
import { _ as _sfc_main$2 } from './Badge-P0JOv5sI.mjs';
import { _ as _sfc_main$3 } from './Slideover-DZ0IYow3.mjs';
import { _ as _sfc_main$4 } from './Select-Di6-gJCC.mjs';
          ...
          if (_push2) {
            ...
            if (loadingItems.value) {
              ...
              _push2(ssrRenderComponent(_component_USelect, {
                ...
                options: products.value.filter((p) => p.is_compound_product != 1).map((p) => ({ value: String(p.id_product), label: `${decode(p.title_product)} (${p.sku_product})` })),
...
//# sourceMappingURL=combos-CmLmo3nB.mjs.map
