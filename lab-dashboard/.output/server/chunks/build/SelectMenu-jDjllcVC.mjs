import { useSlots, useModel, toRef, computed, useTemplateRef, unref, withCtx, createVNode, renderSlot, createTextVNode, toDisplayString, mergeProps, openBlock, createBlock, createCommentVNode, withModifiers, Fragment, renderList, mergeModels, defineComponent, normalizeProps, guardReactiveProps, toRefs, ref, getCurrentInstance, isRef, toRaw, watch, withKeys, withMemo, nextTick, resolveDynamicComponent, watchSyncEffect, cloneVNode, createElementBlock, normalizeStyle, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import { Q as useComponentProps, a7 as useLocale, J as useAppConfig, Y as useFilter, a1 as useForwardProps, a8 as usePortal, $ as useFormField, W as useFieldGroup, O as useComponentIcons, I as tv, C as isArrayOfArray, l as compare$1, s as get, g as _sfc_main$h, j as _sfc_main$f, k as _sfc_main$g, i as _sfc_main$c, F as FieldGroupReset, a as FocusScope_default, h as _sfc_main$6, a6 as useId, a9 as usePrimitiveElement, a0 as useForwardExpose, f as Primitive, S as useDirection, X as useFilter$1, d as PopperRoot_default, G as looseToNumber, P as PopperAnchor_default, u as getDisplayValue, T as Teleport_default, a3 as useForwardPropsEmits, e as Presence_default, b as PopperArrow_default, m as createContext, N as useCollection, ac as useTypeahead, L as useBodyScrollLock, Z as useFocusGuards, a5 as useHideOthers, a2 as useForwardProps$1, D as DismissableLayer_default, c as PopperContent_default, M as MAP_KEY_TO_FOCUS_INTENT, t as getActiveElement, w as getNextMatch, y as handleAndDispatchCustomEvent$1, v as getFocusIntent } from './server.mjs';
import { u as useFormControl } from './useFormControl-9B1GcqCr.mjs';
import { V as VisuallyHiddenInput_default } from './VisuallyHiddenInput-lcZAWR9l.mjs';
import { reactivePick, createReusableTemplate, useVModel, createEventHook, useParentElement } from '@vueuse/core';
                    ...
                    return [
                      renderSlot(_ctx.$slots, "item", {
                        ...
                        renderSlot(_ctx.$slots, "item-leading", {
                          ...
                          isSelectItem(item) && item.icon ? (openBlock(), createBlock(_sfc_main$h, {
                            key: 0,
                            name: item.icon,
                            "data-slot": "itemLeadingIcon",
                            class: ui.value.itemLeadingIcon({ class: [unref(props).ui?.itemLeadingIcon, item.ui?.itemLeadingIcon] })
                                    ...
                                    if (!!unref(props).searchInput) {
                                      _push6(ssrRenderComponent(unref(ComboboxInput_default), {
                                        ...
                                        default: withCtx((_5, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(ssrRenderComponent(_sfc_main$6, mergeProps({
                                              autofocus: "",
                                              autocomplete: "off",
                                              size: selectSize.value
...
//# sourceMappingURL=SelectMenu-jDjllcVC.mjs.map
