...
import { _ as _sfc_main$4 } from './Table-BGh52cFP.mjs';
import { _ as _sfc_main$5 } from './Badge-BLusyd6V.mjs';
import { defineComponent, ref, computed, resolveComponent, mergeProps, withCtx, createVNode, openBlock, createBlock, toDisplayString, createCommentVNode, createTextVNode, withModifiers, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full space-y-6" }, _attrs))}><div class="mb-6"><h1 class="text-2xl font-bold flex items-center gap-2">`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_USelect, {
                    ...
                    options: warehouses.value.map((w) => ({ value: String(w.id_warehouse), label: formatText(w.title_warehouse) })),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_USelect, {
                    ...
                    options: products.value.map((p) => ({ value: String(p.id_product), label: `${formatText(p.title_product)} (Stock: ${p.stock})` })),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (selectedProductData.value) {
                    _push3(`<p class="text-xs text-slate-500 mt-1"${_scopeId2}>Max disponible: ${ssrInterpolate(maxStock.value)}</p>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
                  return [
                    ...
                    }, "Max disponible: " + toDisplayString(maxStock.value), 1)) : createCommentVNode("", true)
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=solicitar-inventario-CiYIu5xJ.mjs.map
