import { defineComponent, computed, watch, openBlock, createBlock, mergeProps, createElementBlock, Fragment, createCommentVNode, renderList, toRefs, unref, withKeys, withModifiers, withCtx, renderSlot, useSlots, useId, useAttrs, createVNode, createTextVNode, toDisplayString, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrInterpolate } from "vue/server-renderer";
import { a4 as usePrimitiveElement, V as VisuallyHidden_default, W as useForwardExpose, f as Primitive, l as createContext, M as useComponentProps, H as useAppConfig, X as useForwardProps, U as useFormField, G as tv, g as _sfc_main$1 } from "../server.mjs";
import { L as Label_default } from "./FormField-H4QVgNpC.js";
import { u as useFormControl } from "./Select-Bk-d3PfC.js";
                  ...
                  _push3(ssrRenderComponent(unref(SwitchThumb_default), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          unref(props).loading ? (openBlock(), createBlock(_sfc_main$1, {
                            key: 0,
                            name: unref(props).loadingIcon || unref(appConfig).ui.icons.loading,
                            "data-slot": "icon",
                            class: ui.value.icon({ class: unref(props).ui?.icon, checked: true, unchecked: true })
                          }, null, 8, ["name", "class"])) : (openBlock(), createBlock(Fragment, { key: 1 }, [
                            unref(props).checkedIcon ? (openBlock(), createBlock(_sfc_main$1, {
                              key: 0,
                              name: unref(props).checkedIcon,
                              "data-slot": "icon",
                              class: ui.value.icon({ class: unref(props).ui?.icon, checked: true })
                            }, null, 8, ["name", "class"])) : createCommentVNode("", true),
                            unref(props).uncheckedIcon ? (openBlock(), createBlock(_sfc_main$1, {
                              key: 1,
                              name: unref(props).uncheckedIcon,
                              "data-slot": "icon",
                              class: ui.value.icon({ class: unref(props).ui?.icon, unchecked: true })
...
//# sourceMappingURL=Switch-CVLe9LZj.js.map
