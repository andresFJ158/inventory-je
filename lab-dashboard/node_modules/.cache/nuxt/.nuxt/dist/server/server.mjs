...
import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, resolveComponent, defineAsyncComponent, Fragment, toRefs, renderSlot, watch, toHandlerKey, camelize, watchEffect, Comment, mergeProps, openBlock, createBlock, normalizeStyle, withCtx, Teleport, createCommentVNode, markRaw, watchPostEffect, createVNode, mergeDefaults, normalizeProps, guardReactiveProps, withModifiers, watchSyncEffect, withKeys, onScopeDispose, createTextVNode, toDisplayString, renderList, resolveDynamicComponent, useSSRContext, useModel, mergeModels, useSlots, useTemplateRef, useId as useId$1, Suspense, createSlots, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/HP/Desktop/Unitech2/inventory-je-master/lab-dashboard/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/HP/Desktop/Unitech2/inventory-je-master/lab-dashboard/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/HP/Desktop/Unitech2/inventory-je-master/lab-dashboard/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/HP/Desktop/Unitech2/inventory-je-master/lab-dashboard/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { shouldHydrate, setActivePinia, createPinia, defineStore } from "pinia";
import defu$1, { defu, defuFn } from "C:/Users/HP/Desktop/Unitech2/inventory-je-master/lab-dashboard/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Users/HP/Desktop/Unitech2/inventory-je-master/lab-dashboard/node_modules/ufo/dist/index.mjs";
import { debounce } from "C:/Users/HP/Desktop/Unitech2/inventory-je-master/lab-dashboard/node_modules/perfect-debounce/dist/index.mjs";
import { hash } from "C:/Users/HP/Desktop/Unitech2/inventory-je-master/lab-dashboard/node_modules/ohash/dist/index.mjs";
import { isPlainObject } from "@vue/shared";
import { klona } from "C:/Users/HP/Desktop/Unitech2/inventory-je-master/lab-dashboard/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "C:/Users/HP/Desktop/Unitech2/inventory-je-master/lab-dashboard/node_modules/@unhead/vue/dist/index.mjs";
...
const _routes = [
  {
    name: "admins",
    path: "/admins",
    component: () => import("./_nuxt/admins-DGwDMKLz.js")
  },
  {
    name: "almacen",
    path: "/almacen",
    component: () => import("./_nuxt/almacen-CMuR7mNs.js")
  },
  {
    name: "almacenes",
    path: "/almacenes",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/almacenes-BTZVi1vy.js")
  },
  {
    name: "caja",
    path: "/caja",
    component: () => import("./_nuxt/caja-DZ-DAAKw.js")
  },
  {
    name: "calidad",
    path: "/calidad",
    component: () => import("./_nuxt/calidad-CyoXy-fJ.js")
  },
  {
    name: "combos",
    path: "/combos",
    component: () => import("./_nuxt/combos-BWEtO6Ay.js")
  },
  {
    name: "consignacion",
    path: "/consignacion",
    component: () => import("./_nuxt/consignacion-CWOjeWDA.js")
  },
  {
    name: "credito",
    path: "/credito",
    component: () => import("./_nuxt/credito-CjA5-fi0.js")
  },
  {
    name: "despachos",
    path: "/despachos",
    component: () => import("./_nuxt/despachos-B9ZSpzFW.js")
  },
  {
    name: "empaques",
    path: "/empaques",
    component: () => import("./_nuxt/empaques-C8bEn2y0.js")
  },
  {
    name: "facturacion",
    path: "/facturacion",
    component: () => import("./_nuxt/facturacion-D5pDLKIK.js")
  },
  {
    name: "ingreso-egreso",
    path: "/ingreso-egreso",
    component: () => import("./_nuxt/ingreso-egreso-_lFx9XfO.js")
  },
  {
    name: "insumos",
    path: "/insumos",
    component: () => import("./_nuxt/insumos-sDjoN9qc.js")
  },
  {
    name: "inventario",
    path: "/inventario",
    component: () => import("./_nuxt/inventario-BoMzqkaa.js")
  },
  {
    name: "inventario-final",
    path: "/inventario-final",
    component: () => import("./_nuxt/inventario-final-C8tAD6zx.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/login-CftrLtWb.js")
  },
  {
    name: "materiales",
    path: "/materiales",
    component: () => import("./_nuxt/materiales-DZqQH0li.js")
  },
  {
    name: "mi-inventario",
    path: "/mi-inventario",
    component: () => import("./_nuxt/mi-inventario-C6Bl-_TH.js")
  },
  {
    name: "pos",
    path: "/pos",
    component: () => import("./_nuxt/pos-CxzBeoFJ.js")
  },
  {
    name: "produccion",
    path: "/produccion",
    component: () => import("./_nuxt/produccion-Br_1FnBg.js")
  },
  {
    name: "proveedores",
    path: "/proveedores",
    component: () => import("./_nuxt/proveedores-6RCt6lDe.js")
  },
  {
    name: "recetas",
    path: "/recetas",
    component: () => import("./_nuxt/recetas-Coae5Nky.js")
  },
  {
    name: "reportes",
    path: "/reportes",
    component: () => import("./_nuxt/reportes-BMfKFaGo.js")
  },
  {
    name: "solicitar-inventario",
    path: "/solicitar-inventario",
    component: () => import("./_nuxt/solicitar-inventario-CiYIu5xJ.js")
  },
  {
    name: "module",
    path: "/:module()",
    component: () => import("./_nuxt/_module_-DIZtglC0.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-8md1wAQq.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-PvAZfIfz.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CeB9RS8E.js"));
...
export {
  useFormField as $,
  injectRovingFocusGroupContext as A,
  inputIdInjectionKey as B,
  isArrayOfArray as C,
  ...
  useAppConfig as J,
  useAuthStore as K,
  useBodyScrollLock as L,
  MAP_KEY_TO_FOCUS_INTENT as M,
  useCollection as N,
  useComponentIcons as O,
  PopperAnchor_default as P,
  useComponentProps as Q,
  ...
  useForwardExpose as a0,
  useForwardProps as a1,
  useForwardProps$1 as a2,
  useForwardPropsEmits as a3,
  useHead as a4,
  useHideOthers as a5,
  useId as a6,
  useLocale as a7,
  usePortal as a8,
  usePrimitiveElement as a9,
  ...
  focusFirst as n,
  focusFirst$1 as o,
  formErrorsInjectionKey as p,
  formFieldInjectionKey as q,
  formInputsInjectionKey as r,
  get as s,
  getActiveElement as t,
  getDisplayValue as u,
  getFocusIntent as v,
  getNextMatch as w,
  getOpenState as x,
  handleAndDispatchCustomEvent$1 as y,
  injectConfigProviderContext as z
};
