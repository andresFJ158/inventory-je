...
import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, resolveComponent, defineAsyncComponent, Fragment, toRefs, renderSlot, watch, toHandlerKey, camelize, watchEffect, Comment, mergeProps, openBlock, createBlock, normalizeStyle, withCtx, Teleport, createCommentVNode, markRaw, watchPostEffect, createVNode, mergeDefaults, normalizeProps, guardReactiveProps, withModifiers, watchSyncEffect, withKeys, onScopeDispose, createTextVNode, toDisplayString, renderList, resolveDynamicComponent, useSSRContext, useModel, mergeModels, useSlots, useTemplateRef, useId as useId$1, Suspense, createSlots, Transition, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/andresfernandez/dev/inventory-je-master/lab-dashboard/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/andresfernandez/dev/inventory-je-master/lab-dashboard/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/andresfernandez/dev/inventory-je-master/lab-dashboard/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/andresfernandez/dev/inventory-je-master/lab-dashboard/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { shouldHydrate, setActivePinia, createPinia, defineStore } from "pinia";
import defu$1, { defu, defuFn } from "/Users/andresfernandez/dev/inventory-je-master/lab-dashboard/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { hasProtocol, isScriptProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/Users/andresfernandez/dev/inventory-je-master/lab-dashboard/node_modules/ufo/dist/index.mjs";
import { debounce } from "/Users/andresfernandez/dev/inventory-je-master/lab-dashboard/node_modules/perfect-debounce/dist/index.mjs";
import { hash } from "/Users/andresfernandez/dev/inventory-je-master/lab-dashboard/node_modules/ohash/dist/index.mjs";
import { isPlainObject } from "@vue/shared";
import { klona } from "/Users/andresfernandez/dev/inventory-je-master/lab-dashboard/node_modules/klona/dist/index.mjs";
import { useHead as useHead$1, headSymbol } from "/Users/andresfernandez/dev/inventory-je-master/lab-dashboard/node_modules/@unhead/vue/dist/index.mjs";
...
import { createSharedComposable, useEventListener, unrefElement, defaultWindow, onKeyStroke, createGlobalState, useMounted, computedEager, useVModel, reactiveOmit, useRafFn, reactivePick, useDebounceFn, createReusableTemplate } from "@vueuse/core";
...
const _routes = [
  {
    name: "almacen",
    path: "/almacen",
    component: () => import("./_nuxt/almacen-ulzeCwXR.js")
  },
  {
    name: "caja",
    path: "/caja",
    component: () => import("./_nuxt/caja-DTNkf_Zb.js")
  },
  {
    name: "calidad",
    path: "/calidad",
    component: () => import("./_nuxt/calidad-BSv-kfKe.js")
  },
  {
    name: "combos",
    path: "/combos",
    component: () => import("./_nuxt/combos-CmLmo3nB.js")
  },
  {
    name: "consignacion",
    path: "/consignacion",
    component: () => import("./_nuxt/consignacion-B6w2mIHi.js")
  },
  {
    name: "credito",
    path: "/credito",
    component: () => import("./_nuxt/credito-C_RiTDYP.js")
  },
  {
    name: "despachos",
    path: "/despachos",
    component: () => import("./_nuxt/despachos-CVUUtFGs.js")
  },
  {
    name: "facturacion",
    path: "/facturacion",
    component: () => import("./_nuxt/facturacion-C4I3Y8aT.js")
  },
  {
    name: "ingreso-egreso",
    path: "/ingreso-egreso",
    component: () => import("./_nuxt/ingreso-egreso-CIo8-YA0.js")
  },
  {
    name: "insumos",
    path: "/insumos",
    component: () => import("./_nuxt/insumos-BKqsCT2_.js")
  },
  {
    name: "inventario",
    path: "/inventario",
    component: () => import("./_nuxt/inventario-n7rbf2xL.js")
  },
  {
    name: "inventario-final",
    path: "/inventario-final",
    component: () => import("./_nuxt/inventario-final-BAujoi3K.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/login-B2FgKQb9.js")
  },
  {
    name: "materiales",
    path: "/materiales",
    component: () => import("./_nuxt/materiales-CNwT4O7N.js")
  },
  {
    name: "mi-inventario",
    path: "/mi-inventario",
    component: () => import("./_nuxt/mi-inventario-B-M9YP76.js")
  },
  {
    name: "pos",
    path: "/pos",
    component: () => import("./_nuxt/pos-eqnG5Ie5.js")
  },
  {
    name: "produccion",
    path: "/produccion",
    component: () => import("./_nuxt/produccion-C6EwTXXQ.js")
  },
  {
    name: "proveedores",
    path: "/proveedores",
    component: () => import("./_nuxt/proveedores-cSW-GZp1.js")
  },
  {
    name: "recetas",
    path: "/recetas",
    component: () => import("./_nuxt/recetas-CamTv7Ty.js")
  },
  {
    name: "reportes",
    path: "/reportes",
    component: () => import("./_nuxt/reportes-39whbxKY.js")
  },
  {
    name: "solicitar-inventario",
    path: "/solicitar-inventario",
    component: () => import("./_nuxt/solicitar-inventario-DLOs2Dto.js")
  },
  {
    name: "module",
    path: "/:module()",
    component: () => import("./_nuxt/_module_-Cs1Fga_U.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Bk2TliAS.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DEVfixfE.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-rXSZ-VCA.js"));
...
export {
  ...
  useAppConfig as G,
  useAuthStore as H,
  useBodyScrollLock as I,
  useCollection as J,
  useComponentIcons as K,
  useComponentProps as L,
  useDirection as M,
  useEmitAsProps as N,
  useFieldGroup as O,
  PopperAnchor_default as P,
  useFocusGuards as Q,
  RovingFocusGroup_default as R,
  useFormField as S,
  Teleport_default as T,
  useForwardExpose as U,
  VisuallyHidden_default as V,
  useForwardProps as W,
  useForwardProps$1 as X,
  useForwardPropsEmits as Y,
  useHead as Z,
  __nuxt_component_0$1 as _,
  FocusScope_default as a,
  useId as a0,
  useLocale as a1,
  usePortal as a2,
  usePrimitiveElement as a3,
  useRuntimeConfig as a4,
  useToast as a5,
  useTypeahead as a6,
  wrapArray as a7,
  PopperArrow_default as b,
  PopperContent_default as c,
  PopperRoot_default as d,
  entry_default as default,
  Presence_default as e,
  Primitive as f,
  _sfc_main$c as g,
  _sfc_main$h as h,
  _sfc_main$f as i,
  ...
  focusFirst as m,
  focusFirst$1 as n,
  formErrorsInjectionKey as o,
  formFieldInjectionKey as p,
  formInputsInjectionKey as q,
  get as r,
  getActiveElement as s,
  getDisplayValue as t,
  getFocusIntent as u,
  getOpenState as v,
  handleAndDispatchCustomEvent$1 as w,
  injectConfigProviderContext as x,
  injectRovingFocusGroupContext as y,
  inputIdInjectionKey as z
};
