...
(16,'lab_admin@test.com','$2a$07$azybxcags23425sdg23sdeIan4HEpwM2Drf8UCPl2mT7va7LrTnPe','lab_admin',NULL,'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3NzkyOTk2NzAsImV4cCI6MTc3OTM4NjA3MCwiZGF0YSI6eyJpZCI6MTYsImVtYWlsIjoibGFiX2FkbWluQHRlc3QuY29tIn19.jnBGUYhic12uJ11uVLuROZIv5GpT6P0qB7V6eV4ehx0','1779386070',1,NULL,NULL,NULL,NULL,NULL,NULL,'Admin Laboratorio',5,NULL,'2026-05-19','2026-05-20 17:54:30'),
(17,'lab_worker@test.com','$2a$07$azybxcags23425sdg23sdeC2NECjCAoAjT6Sdo7/xN8dPDW8PHutu','lab_worker',NULL,'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3NzkzMDA0MzIsImV4cCI6MTc3OTM4NjgzMiwiZGF0YSI6eyJpZCI6MTcsImVtYWlsIjoibGFiX3dvcmtlckB0ZXN0LmNvbSJ9fQ.h6ONYEajggPgvEeMX3tAdxMSthuLIir4SMJlhEh-bd4','1779386832',1,NULL,NULL,NULL,NULL,NULL,NULL,'Trabajador Laboratorio',5,NULL,'2026-05-19','2026-05-20 18:07:12');
...
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(3,1,3,12,45,'100%25',90,5,225,'2025-10-30','2025-11-01 00:15:08','compra','pendiente',NULL,NULL),
(4,1,3,12,50,'100%25',100,15,750,'2025-10-31','2025-11-01 00:14:51','compra','pendiente',NULL,NULL),
(5,1,4,13,45,'100%25',90,20,900,'2025-10-31','2025-11-01 01:53:23','compra','pendiente',NULL,NULL),
(6,1,4,15,80,'100%25',160,25,2000,'2025-10-31','2025-11-01 01:53:52','compra','pendiente',NULL,NULL),
(7,1,3,14,80,'100%25',160,30,2400,'2025-10-31','2025-11-01 01:54:43','compra','pendiente',NULL,NULL),
(8,1,3,18,45,'100%25',90,15,675,'2025-11-04','2025-11-04 18:18:58','compra','pendiente',NULL,NULL),
(9,1,3,16,45,'100%25',90,15,675,'2025-11-04','2025-11-04 18:19:23','compra','pendiente',NULL,NULL),
(10,1,3,21,45,'100%25',90,15,675,'2025-11-04','2025-11-04 18:31:16','compra','pendiente',NULL,NULL),
(11,2,3,23,45,'100%25',90,5,225,'2025-11-04','2025-11-04 19:05:32','compra','pendiente',NULL,NULL),
(12,1,3,25,45,'100%25',95,10,450,'2025-11-08','2025-11-08 04:52:32','compra','pendiente',NULL,NULL);
...
(1,1,20,50,1000,'10','dasdasdsad',NULL,'aprobado',17,16,'2026-05-18','2026-05-20',NULL,'2026-05-20 17:19:48'),
(2,2,15,30,450,'','',NULL,'aprobado',17,16,'2026-05-20','2026-05-20',NULL,'2026-05-20 17:54:42');
...
(1,'frutilla','kg','unit','',20,5,17,1,NULL,'2026-05-20 18:10:37'),
(2,'sandia','pza','unit','',15,5,17,1,NULL,'2026-05-20 18:10:37'),
(3,'manzana','und','unit','',0,5,17,1,NULL,'2026-05-20 18:03:35');
...
CREATE TABLE `sales` (
  ...
  PRIMARY KEY (`id_sale`)
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
