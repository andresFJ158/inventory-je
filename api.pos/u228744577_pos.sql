...
-- Phase 1, Phase 2 & Phase 3 Migrations Added Programmatically
ALTER TABLE offices ADD COLUMN IF NOT EXISTS type_office TEXT NULL DEFAULT 'sucursal';
ALTER TABLE products ADD COLUMN IF NOT EXISTS is_compound_product INT DEFAULT 0;
ALTER TABLE products ADD COLUMN IF NOT EXISTS origin_office_product INT DEFAULT 0;
ALTER TABLE purchases ADD COLUMN IF NOT EXISTS type_purchase TEXT NULL DEFAULT 'compra';
ALTER TABLE purchases ADD COLUMN IF NOT EXISTS status_purchase TEXT NULL DEFAULT 'pendiente';
ALTER TABLE purchases ADD COLUMN IF NOT EXISTS received_date_purchase DATE NULL;
ALTER TABLE purchases ADD COLUMN IF NOT EXISTS received_by_purchase INT NULL;
ALTER TABLE purchases ADD COLUMN IF NOT EXISTS may_product DOUBLE DEFAULT 0;
ALTER TABLE purchases ADD COLUMN IF NOT EXISTS wholesale_quantity INT DEFAULT 0;
...
ALTER TABLE productions ADD COLUMN IF NOT EXISTS id_packaged_product INT DEFAULT 0;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS pkg_labor_cost DOUBLE DEFAULT 0;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS pkg_indirect_cost DOUBLE DEFAULT 0;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS real_bulk_qty DOUBLE DEFAULT NULL;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS yield_variance DOUBLE DEFAULT NULL;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS yield_variance_pct DOUBLE DEFAULT NULL;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS qty_packaged_production DOUBLE DEFAULT NULL;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS qty_approved_production DOUBLE DEFAULT NULL;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS qty_rejected_production DOUBLE DEFAULT NULL;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS result_qc_production VARCHAR(30) DEFAULT NULL;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS notes_qc_production TEXT DEFAULT NULL;
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS status_supplier INT DEFAULT 1;
ALTER TABLE suppliers ADD COLUMN IF NOT EXISTS type_supplier VARCHAR(50) DEFAULT 'ambos';
ALTER TABLE clients ADD COLUMN IF NOT EXISTS nit_client VARCHAR(50) DEFAULT NULL;
...
ALTER TABLE admins ADD COLUMN IF NOT EXISTS surname_admin TEXT NULL DEFAULT NULL;
ALTER TABLE admins ADD COLUMN IF NOT EXISTS img_admin TEXT NULL DEFAULT NULL;
ALTER TABLE admins ADD COLUMN IF NOT EXISTS type_seller VARCHAR(50) DEFAULT 'cajero';
ALTER TABLE products ADD COLUMN IF NOT EXISTS initial_stock_product DOUBLE DEFAULT 0;
ALTER TABLE cashs ADD COLUMN IF NOT EXISTS cash_efectivo DOUBLE DEFAULT 0;
ALTER TABLE cashs ADD COLUMN IF NOT EXISTS cash_qr DOUBLE DEFAULT 0;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS qr_ref_order VARCHAR(255) DEFAULT NULL;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS method_detail_order TEXT DEFAULT NULL;
ALTER TABLE raw_materials ADD COLUMN IF NOT EXISTS no_stock_raw_material INT DEFAULT 0;
ALTER TABLE raw_materials ADD COLUMN IF NOT EXISTS price_raw_material DOUBLE DEFAULT 0;
...
ALTER TABLE productions ADD COLUMN IF NOT EXISTS waste_qty_production DOUBLE DEFAULT 0;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS waste_packaged_qty DOUBLE DEFAULT 0;
ALTER TABLE productions ADD COLUMN IF NOT EXISTS waste_loss_qty DOUBLE DEFAULT 0;

ALTER TABLE admins ADD COLUMN IF NOT EXISTS id_inventory_admin INT DEFAULT NULL;
ALTER TABLE admins ADD COLUMN IF NOT EXISTS pct_commission_admin DOUBLE DEFAULT 0;
...
ALTER TABLE products ADD COLUMN IF NOT EXISTS combo_price_mode VARCHAR(20) DEFAULT 'descuento';
